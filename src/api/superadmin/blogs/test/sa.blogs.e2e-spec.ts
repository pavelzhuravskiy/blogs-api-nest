...
import { saBlogObject } from '../../../../../test/objects/blogs.objects';

describe('SuperAdmin blogs testing', () => {
  ...
  describe('SuperAdmin blogs operations and errors checks', () => {
    ...
    describe('Bind blog', () => {
      ...
      it(`should bind blog to user 02 and get all blogs`, async () => {
        ...
        console.log(blogs.body.items[0].blogOwnerInfo);
